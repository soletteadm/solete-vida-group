                ...
                {[
                  ...
                  <li key={link.section}>
                    <button
                      ...
                      className="font-sans text-sm text-white/70 hover:text-coral transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-coral rounded"
                      data-ocid="nav.link"
                    >
                      {link.label}
                    </button>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3">
                ...
                <a
                  ...
                  className="font-sans text-sm text-white/70 hover:text-coral transition-colors"
                >
                  {t.footer.email}
                </a>
              </li>
